...
public class GasBillPayFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragmrnt_gasbill,container,false);
    ...
    public void onResume() {
        ...
        ((MainActivity2) getActivity()).setActionBarTitle("Gas");
    }
